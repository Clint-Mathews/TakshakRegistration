...
public class RegEvent extends AppCompatActivity implements View.OnClickListener {
    Drawer result = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regevent);
        //ViewReg objects
...
//        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Click action
                Intent i = new Intent(RegEvent.this,RegPage.class);
                    ...
                    client.post("http://takshak.in/2017/public/registration/RegisterEvent", params, new JsonHttpResponseHandler() {
                        ...
                        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                            ...
                            try {
                                ...
                                if(status){
                                    Toast.makeText(RegEvent.this, "Done",Toast.LENGTH_LONG).show();
                                }
                                else{
                                    Toast.makeText(RegEvent.this, "Failed",Toast.LENGTH_LONG).show();
                                }
                            } catch (JSONException e) {
                                Toast.makeText(RegEvent.this, e.getMessage(),Toast.LENGTH_LONG).show();
                            }
                        }
            ...
            try {
                ...
                if(code1!=10000){
                    for(int i=0;i<ptr;i++){
                        if(code1==code[i]){
                            fl=0;
                            Toast.makeText(RegEvent.this,"Already Added",Toast.LENGTH_LONG).show();
                            break;
                        }else fl=1;
                    }
